...
<template>
    ...
    <div class="flex h-screen">
        <!-- Left Pane -->
        <div class="w-full bg-cyan-700 lg:w-1/2 flex items-center justify-center">
            <div class="max-w-md w-full">
                <svg xmlns="http://www.w3.org/2000/svg" id="currentIllo" data-name="Layer 1" width="600.99994"
                    height="520.13854" viewBox="0 0 869.99994 520.13854" class="injected-svg illopage__image"
                    ...
                    <circle cx="524.99994" cy="335.5" r="16" fill="#bebdc5" />
                    ...
                    <path
                        ...
                        transform="translate(-165.00003 -189.93073)" fill="#bebdc5" />
                    <path
