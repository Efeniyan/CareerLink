<script setup >
const url = "https://unpkg.com/flowbite@1.4.1/dist/flowbite.js"

</script>


<template>
  <nav class="border-solid sticky top-0 border-gray-200 w-full border-b py-3 bg-white z-50 bg-inherit">
