...
function openNav() {
    ...
    document.getElementById("head-container").style.marginRight = "250px";
}

function closeNav() {
    isNavOpen.value = false;
    document.getElementById("mySidenav").style.width = "0";
    document.getElementById("head-container").style.marginRight = "0";
}
</script>
    ...
    <div id="head-container">
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <p><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                ...
                <RouterLink to="/statistiques">Stats</RouterLink>
            </p>
            <p><svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960" width="24px"
                ...
                <RouterLink to="/allJob">All Jobs</RouterLink>
            </p>
            <p><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#FFFFFF">
                    <path
                ...
                <RouterLink to="/addJobs">Add Job</RouterLink>
            </p>
...
.sidenav {
    ...
    z-index: 1;
    top: 0;
    right: 0;  /* Modifié pour placer le menu à droite */
